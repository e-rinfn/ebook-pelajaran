                ...
                <div class="my-3 my-md-5">
                    <div class="container">
                        ...
                        <div class="action-bar mb-3 d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="cetak_excel.php?search=<?= urlencode($search) ?>" class="btn btn-success ml-2">
                                    <i class="fe fe-download"></i> Export Excel
                                </a>
                                <a href="cetak_pdf.php?search=<?= urlencode($search) ?>" class="btn btn-danger ml-2" target="_blank">
